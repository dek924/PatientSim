...
if __name__ == "__main__":
    ...
    # Patient bias
    parser.add_argument("--cefr_type", type=str, help="Patient cefr type", required=True, choices=["A", "B", "C"])
    parser.add_argument(
        "--personality_type",
        type=str,
        help="Patient personality type",
        required=True,
        choices=["plain", "verbose", "distrust", "pleasing", "impatient", "overanxious"],
    )
    parser.add_argument("--dazed_level_type", type=str, help="Patient cognitive confusion level type", required=True, choices=["normal", "high"])
    parser.add_argument("--recall_level_type", type=str, help="Patient medical history recall level type", required=True, choices=["low", "high"])
